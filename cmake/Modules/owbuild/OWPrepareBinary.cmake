...
macro (OW_PREPARE_BINARY)
	...
	ow_unique(unique ${${PROJECT_NAME}_PUBLIC_DEFINITIONS} ${${PROJECT_NAME}_PRIVATE_DEFINITIONS})
	add_definitions(${unique})

	ow_unique(unique ${${PROJECT_NAME}_PUBLIC_INCLUDE_DIRS} ${${PROJECT_NAME}_PRIVATE_INCLUDE_DIRS})
