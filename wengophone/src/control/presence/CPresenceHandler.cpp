...
#include "CPresenceHandler.h"

#include <model/presence/PresenceHandler.h>
#include <presentation/PFactory.h>

CPresenceHandler::CPresenceHandler(PresenceHandler & presenceHandler) 
	: _presenceHandler(presenceHandler) {

	_pPresenceHandler = PFactory::getFactory().createPresentationPresenceHandler(*this);
