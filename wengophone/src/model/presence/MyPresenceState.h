...
public:
	 ...
	 */
	virtual MyPresenceState * online() throw (MyPresenceStateException) = 0;
	 ...
	 */
	virtual MyPresenceState * offline() throw (MyPresenceStateException) = 0;
	 ...
	 */
	virtual MyPresenceState * doNotDisturb() throw (MyPresenceStateException) = 0;
	 ...
	 */
	virtual MyPresenceState * away() throw (MyPresenceStateException) = 0;
