...
#ifndef MYPRESENCESTATEDONOTDISTURB_H
#define MYPRESENCESTATEDONOTDISTURB_H
 ...
 */
class MyPresenceStateDoNotDisturb : public MyPresenceState {
public:
	...
	static MyPresenceState * getInstance() {
		static MyPresenceStateDoNotDisturb presenceState;
...
#endif	//MYPRESENCESTATEDONOTDISTURB_H
