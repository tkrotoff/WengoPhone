 ...
 * @param hvalue The string describing the element.
 */
  int osip_message_set_replaces (osip_message_t * sip, const char *hvalue);



/**
 * Get the Replaces header.
 * @param sip The element to work on.
 * @param header pointe to the header
 */
  osip_replaces_t *osip_message_get_replaces (const osip_message_t * sip);
