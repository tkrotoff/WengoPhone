...
*/
PHAPI_UTIL_EXPORTS unsigned int pointer_equals(void * element_a, void * element_b){
...
*/
PHAPI_UTIL_EXPORTS unsigned int char_equals(void * element_a, void * element_b){
	char _a;
	char _b;
...
*/
PHAPI_UTIL_EXPORTS unsigned int string_equals(void * element_a, void * element_b){
	char * _a;
	char * _b;
...
*/
PHAPI_UTIL_EXPORTS unsigned int int_equals(void * element_a, void * element_b){
	int _a;
	int _b;
