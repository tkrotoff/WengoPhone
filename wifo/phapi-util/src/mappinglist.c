...
*/
PHAPI_UTIL_EXPORTS mappinglist_t * create_mappinglist(){
	mappinglist_t * list;
...
*/
PHAPI_UTIL_EXPORTS unsigned int mappinglist_put(mappinglist_t * list, void * key, void * element, unsigned int (*equals)(void *, void *)){
...
* @return	TRUE if the add was successful; FALSE else
*/
PHAPI_UTIL_EXPORTS unsigned int mappinglist_put_with_int_key(mappinglist_t * list, int key, void * element){
	mappinglist_link_t * new_link;
	mappinglist_link_t * link;
...
*/
PHAPI_UTIL_EXPORTS void * mappinglist_remove(mappinglist_t * list, void * key, unsigned int (*equals)(void *, void *)){
	mappinglist_link_t * link;
...
* @return	the removed element if the suppression was successful; NULL else
*/
PHAPI_UTIL_EXPORTS void * mappinglist_remove_with_int_key(mappinglist_t * list, int key){
	mappinglist_link_t * link;
	mappinglist_link_t * previous_link;
	void * element;
...
* @return	the removed element if the suppression was successful; NULL else
*/
PHAPI_UTIL_EXPORTS void * mappinglist_get(mappinglist_t * list, void * key, unsigned int (*equals)(void *, void *)){
	mappinglist_link_t * link;
	mappinglist_link_t * previous_link;
...
* @return	the removed element if the suppression was successful; NULL else
*/
PHAPI_UTIL_EXPORTS void * mappinglist_get_with_int_key(mappinglist_t * list, int key){
	mappinglist_link_t * link;
	mappinglist_link_t * previous_link;
...
*/
PHAPI_UTIL_EXPORTS unsigned int mappinglist_contains_key(mappinglist_t * list, void * key, unsigned int (*equals)(void *, void *)){
	mappinglist_link_t * link;
...
* @return	TRUE if the key is already used in the list; FALSE else
*/
PHAPI_UTIL_EXPORTS unsigned int mappinglist_contains_int_key(mappinglist_t * list, int key){
	mappinglist_link_t * link;
...
*/
PHAPI_UTIL_EXPORTS unsigned int mappinglist_contains_element(mappinglist_t * list, void * element, unsigned int (*equals)(void *, void *)){
	mappinglist_link_t * link;
