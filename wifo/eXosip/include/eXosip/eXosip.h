...
struct eXosip_tunnel {
	void*			h_tunnel;
	int				(*get_tunnel_socket) (void *h_tunnel);
...
typedef struct eXosip_tunnel	eXosip_tunnel_t;

/**
 * @ Force the use of tunnel (http tunnel) for sip messages
 * 
 */
int eXosip_set_tunnel(eXosip_tunnel_t *tunnel);
 ...
 */
int   eXosip_options(char *from, char *to, char *route);
 ...
 */
int   eXosip_answer_call   (int jid, int status, char *local_sdp_port, char *ctct, char *local_video_port, char *public_sdp_port, char *public_video_port);
