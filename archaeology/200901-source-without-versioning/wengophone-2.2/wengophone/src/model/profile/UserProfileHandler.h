...
public:
	 ...
	 */
	Event<void (SipAccount & sipAccount, EnumSipLoginState::SipLoginState state)> sipAccountConnectionFailedEvent;
...
private:
	...
	void sipAccountConnectionFailedEventHandler(EnumSipLoginState::SipLoginState);
	void sipAccountConnectionFailedEventHandlerThreadSafe(EnumSipLoginState::SipLoginState);
