...
MyPresenceState * MyPresenceStateAway::offline() {
	return MyPresenceStateOffline::getInstance();
}

MyPresenceState * MyPresenceStateAway::online() {
	return MyPresenceStateOnline::getInstance();
}

MyPresenceState * MyPresenceStateAway::doNotDisturb() {
	return MyPresenceStateDoNotDisturb::getInstance();
}

MyPresenceState * MyPresenceStateAway::away() {
	return this;
}

MyPresenceState * MyPresenceStateAway::invisible() {
