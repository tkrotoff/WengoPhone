...
MyPresenceState * MyPresenceStateDoNotDisturb::offline() {
	return MyPresenceStateOffline::getInstance();
}

MyPresenceState * MyPresenceStateDoNotDisturb::online() {
	return MyPresenceStateOnline::getInstance();
}

MyPresenceState * MyPresenceStateDoNotDisturb::doNotDisturb() {
	return this;
}

MyPresenceState * MyPresenceStateDoNotDisturb::away() {
	return MyPresenceStateAway::getInstance();
}

MyPresenceState * MyPresenceStateDoNotDisturb::invisible() {
