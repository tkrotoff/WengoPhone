...
MyPresenceState * MyPresenceStateInvisible::offline() {
	return MyPresenceStateOffline::getInstance();
}

MyPresenceState * MyPresenceStateInvisible::online() {
	return MyPresenceStateOnline::getInstance();
}

MyPresenceState * MyPresenceStateInvisible::doNotDisturb() {
	return MyPresenceStateDoNotDisturb::getInstance();
}

MyPresenceState * MyPresenceStateInvisible::away() {
	return MyPresenceStateAway::getInstance();
}

MyPresenceState * MyPresenceStateInvisible::invisible() {
	return this;
}
