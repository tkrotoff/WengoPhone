...
public:
	...
	virtual void sipAccountConnectionFailedEventHandler(const SipAccount & sipAccount, EnumSipLoginState::SipLoginState);
...
Q_SIGNALS:
	 ...
	 */
	void sipAccountConnectionFailedEventHandlerSignal(SipAccount* sipAccount, EnumSipLoginState::SipLoginState);
...
private Q_SLOTS:
	 ...
	 * @see sipAccountConnectionFailedEventHandler
	 */
	void sipAccountConnectionFailedEventHandlerSlot(SipAccount* sipAccount, EnumSipLoginState::SipLoginState);
