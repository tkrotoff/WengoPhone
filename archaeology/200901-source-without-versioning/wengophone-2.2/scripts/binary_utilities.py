...
def is_binary_file(path):
	...
	for line in pipe:
		...
		# shared and executable: Linux shared library and executable
		if line.find("Mach-O")  != -1 \
			or line.find("shared") != -1 \
			or line.find("executable") != -1:
			result = True
	pipe.close()
	return result
...
if __name__ == "__main__":
	print is_system_library("libQtCore.so.4")
