...
public:
	...
	class Helper {
	public:
		OWUTIL_API Helper(const char* component, Level, const char* className, const char* fileName, int line);
		OWUTIL_API void operator()(const std::string& message);
		OWUTIL_API void operator()(const char* format, ...);
	 ...
	 */
	OWUTIL_API void setLogFileName(const std::string& logFileName);

	OWUTIL_API std::string getLogFileName() const;

	/** Singleton. */
	static OWUTIL_API Logger* getInstance();

	OWUTIL_API ~Logger();

	OWUTIL_API Helper getHelper(const char* component, Logger::Level, const char* className, const char* filename, int line);

	OWUTIL_API void debug(const std::string & component, const std::string & className, const std::string & message);

	OWUTIL_API void info(const std::string & component, const std::string & className, const std::string & message);

	OWUTIL_API void warn(const std::string & component, const std::string & className, const std::string & message);

	OWUTIL_API void error(const std::string & component, const std::string & className, const std::string & message);

	OWUTIL_API void fatal(const std::string & component, const std::string & className, const std::string & message, const char* filename, int line);
	...
	OWUTIL_API void log(const std::string & component, Level level, const std::string & className, const std::string & message,
