 ...
 *
 * End of line character should be LF (UNIX) rather than CR LF (Windows).
 * Code documentation should be inside header files using the javadoc standard.
 *
 * @see doc/WengoPhoneCodeConventions.odt
 * @see http://dev.openwengo.com/trac/openwengo/trac.cgi/wiki/WengoPhoneCodeConventions
