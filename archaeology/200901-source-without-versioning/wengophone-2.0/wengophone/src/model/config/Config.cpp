...
void Config::fixWenboxConfigHack() {
	std::string configFilename = getConfigDir() + "config.xml";
	...
	if (iConfigFile.open()) {
		...
		data.replace("<wenbox.enable><bool>0</bool></wenbox.enable>", "<wenbox.enable><string>WenboxStatusNotConnected</string></wenbox.enable>");
		data.replace("<wenbox.enable><bool>1</bool></wenbox.enable>", "<wenbox.enable><string>WenboxStatusEnable</string></wenbox.enable>");
