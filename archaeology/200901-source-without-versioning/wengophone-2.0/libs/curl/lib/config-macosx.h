...
#define DL_LBER_FILE "liblber`test .$module = .yes && echo .so || echo .dylib`"

/* ldap dynamic library file */
#define DL_LDAP_FILE "libldap`test .$module = .yes && echo .so || echo .dylib`"
...
/* cpu-machine-OS */
#define OS "powerpc-apple-darwin8.2.0"
