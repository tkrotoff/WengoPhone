...
public:
	 ...
	 */
	Event<void (UserProfileHandler & sender,
		SipAccount & sipAccount)> sipAccountNotValidEvent;
	 ...
	 */
	void setCurrentUserProfile(const std::string & name, const SipAccount & sipAccount);
	 ...
	 *
	 * @param sipAccount a UserProfile is identified with a SipAccount.
	 */
	void createAndSetUserProfile(SipAccount & sipAccount);
...
private:
	...
	void wengoAccountValidityEventHandlerThreadSafe(UserProfile & sender, bool valid);

	/**
	 * @see UserProfile::wengoAccountValidityEvent
	 */
	void wengoAccountValidityEventHandlerForInitialize(UserProfile & sender, bool valid);
	void wengoAccountValidityEventHandlerForInitializeThreadSafe(UserProfile & sender, bool valid);
