...
public:
	 ...
	 */
	void addToHistory(const QString & senderName, const QString & str, const QString & date = "");
...
private:
	...
	/**
	 * Disable send button if necessary
	 */
	void setSendDisable(QString contactName = "");
