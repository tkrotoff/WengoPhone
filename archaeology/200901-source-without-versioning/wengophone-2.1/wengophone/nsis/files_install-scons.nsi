...
!ifdef DEBUG
	!include "files_install_debug-scons.nsi"
!else
	!include "files_install_release-scons.nsi"
!endif
...
!ifndef WITHOUT_PDB
	...
	File "${BUILD_DIR}\curl.pdb"
!endif

/** Gaim plugins. */
SetOutPath "$INSTDIR\plugins\"
File "${BUILD_DIR}\plugins\libaim.dll"
File "${BUILD_DIR}\plugins\libicq.dll"
