...
/**
 * Sets an external log function.
 *
 * @param cbk external log function
 */
 ...
 */
NETLIB_BOOLEAN udp_sip_ping(const char *sip_server, int sip_port, int local_port, int ping_timeout, const char *sip_login, const char *sip_realm);
