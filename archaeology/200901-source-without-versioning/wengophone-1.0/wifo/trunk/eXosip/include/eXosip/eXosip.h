...
int   eXosip_initiate_call    (osip_message_t *invite, void *reference,
			       void *sdp_context_reference, char *local_sdp_port, char *local_sdp_video_port);
 ...
 */
int   eXosip_answer_call   (int jid, int status, char *local_sdp_port, char *ctct, char *local_video_port);
