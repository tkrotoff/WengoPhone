...
def WengoCreateVCProj(env, target, sources, buildtarget):
    """Generates a project file for Microsoft Visual C++"""
    tmp = []
    for str in sources:
...
wengoenv.WengoEnvInstallFunction('WengoCreateVCProj', WengoCreateVCProj)
