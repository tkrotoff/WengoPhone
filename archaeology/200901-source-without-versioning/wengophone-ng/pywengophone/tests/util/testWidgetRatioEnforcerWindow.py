...
import sys, os
from util.WidgetRatioEnforcer import *
...
class TestWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.__window = WidgetRatioEnforcer(self)
        self.__window.setRatio(1)
        self.__window.setChild(self.__button)
        ...
        layout2.addWidget(self.__window)
