 ...
 */
class QTCOREUTIL_API MouseMoveEventFilter : public EventFilter {
public:
 ...
 * @author Tanguy Krotoff
 */
class QTCOREUTIL_API MousePressEventFilter : public EventFilter {
public:
 ...
 * @author Tanguy Krotoff
 */
class QTCOREUTIL_API MouseReleaseEventFilter : public EventFilter {
public:
 ...
 * @author Tanguy Krotoff
 */
class QTCOREUTIL_API MouseHoverEnterEventFilter : public EventFilter {
public:
 ...
 * @author Tanguy Krotoff
 */
class QTCOREUTIL_API MouseHoverLeaveEventFilter : public EventFilter {
public:
