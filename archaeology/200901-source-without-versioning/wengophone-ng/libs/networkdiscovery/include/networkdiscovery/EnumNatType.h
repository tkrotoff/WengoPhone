...
/**
 * NAT types from STUN accountType.
 *
...
public:
	 ...
	 * @return the string
	 */
	NETWORKDISCOVERY_API static std::string toString(NatType natType);
	 ...
	 * @return the NatType
	 */
	NETWORKDISCOVERY_API static NatType toNatType(const std::string & natType);
};
