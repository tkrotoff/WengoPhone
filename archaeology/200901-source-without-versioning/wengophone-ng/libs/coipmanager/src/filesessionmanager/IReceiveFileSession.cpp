...
IReceiveFileSession::IReceiveFileSession(const IReceiveFileSession & iReceiveFileSession)
	: IFileSession(iReceiveFileSession) {
...
void IReceiveFileSession::setFilePath(const std::string & path) {
	_filePath = path;
}

std::string IReceiveFileSession::getFilePath() const {
	return _filePath;
}

std::string IReceiveFileSession::getFileName() const {
	return _fileName;
}

unsigned IReceiveFileSession::getFileSize() const {
	return _fileSize;
}
