...
SyncManager::SyncManager(CoIpManager & coIpManager)
...
void SyncManager::uninitialize() {
	ICoIpManager::uninitialize();
}

ISyncManagerPluginList SyncManager::getISyncManagerPluginList() const {
	return _iSyncManagerList;
}
