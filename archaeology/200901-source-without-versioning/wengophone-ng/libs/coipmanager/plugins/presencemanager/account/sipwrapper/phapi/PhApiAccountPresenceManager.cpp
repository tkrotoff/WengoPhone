...
#include "PhApiAccountPresenceManager.h"

#include <PhApiWrapper.h>

IAccountPresenceManagerPlugin * coip_accountpresence_plugin_init(CoIpManager & coIpManager) {
	return new PhApiAccountPresenceManager(coIpManager);
}

PhApiAccountPresenceManager::PhApiAccountPresenceManager(CoIpManager & coIpManager)
	: SipWrapperBasedAccountPresenceManager(coIpManager) {
