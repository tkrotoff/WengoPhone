...
#ifndef OWSIPWRAPPERACCOUNTPRESENCEMANAGER_H
#define OWSIPWRAPPERACCOUNTPRESENCEMANAGER_H
...
/**
 * SipWrapper implementation of IAccountPresenceManager.
 *
 * @author Philippe Bernery
 */
class SipWrapperBasedAccountPresenceManager : public IAccountPresenceManagerPlugin {
public:

	SipWrapperBasedAccountPresenceManager(CoIpManager & coIpManager);
...
#endif //OWSIPWRAPPERACCOUNTPRESENCEMANAGER_H
