...
#ifndef OWCONNECTEDSTATE_H
#define OWCONNECTEDSTATE_H
 ...
 */
class ConnectedState : public IConnectState {
public:

	ConnectedState(IConnectPlugin & context);
