 ...
 */
class WengoAccountParser : NonCopyable {
public:

	SSOREQUEST_API WengoAccountParser(WengoAccount & account, const std::string & data);
	 ...
	 */
	SSOREQUEST_API bool isLoginPasswordOk() const;
