...
#ifndef OWTSENDFILESESSION_H
#define OWTSENDFILESESSION_H
 ...
 */
class COIPMANAGER_THREADED_API TSendFileSession : public TIFileSession {
	Q_OBJECT
	friend class TFileSessionManager;
public:

	virtual ~TSendFileSession();
...
private:
	...
	TSendFileSession(TCoIpManager & TCoIpManager);
};

#endif //OWTSENDFILESESSION_H
