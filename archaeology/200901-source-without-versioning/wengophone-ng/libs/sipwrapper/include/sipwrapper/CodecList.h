...
#ifndef OWCODECLIST_H
#define OWCODECLIST_H
...
public:
	 ...
	 * @return the string
	 */
	SIPWRAPPER_API static std::string toString(AudioCodec audioCodec);
	 ...
	 * @return the string
	 */
	SIPWRAPPER_API static std::string toString(VideoCodec videoCodec);
};
