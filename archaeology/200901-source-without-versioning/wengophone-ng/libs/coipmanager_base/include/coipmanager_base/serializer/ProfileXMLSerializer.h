...
#ifndef OWPROFILEXMLSERIALIZER_H
#define OWPROFILEXMLSERIALIZER_H
 ...
 */
class COIPMANAGER_BASE_API ProfileXMLSerializer : public Serializable {
public:
...
#endif	//OWPROFILEXMLSERIALIZER_H
