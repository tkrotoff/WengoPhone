...
public:
	 ...
	 */
	SOUND_API std::list<AudioDevice> getInputDeviceList();
	 ...
	 */
	SOUND_API std::list<AudioDevice> getOutputDeviceList();
	 ...
	 */
	SOUND_API AudioDevice getDefaultOutputDevice();
	 ...
	 */
	SOUND_API bool setDefaultOutputDevice(const AudioDevice & audioDevice);
	 ...
	 */
	SOUND_API AudioDevice getDefaultInputDevice();
	 ...
	 * false if an error occured
	 */
	SOUND_API bool setDefaultInputDevice(const AudioDevice & audioDevice);

private:

	/** DLL Exported because of Singleton, otherwise causes a link error. */
	SOUND_API AudioDeviceManager();
