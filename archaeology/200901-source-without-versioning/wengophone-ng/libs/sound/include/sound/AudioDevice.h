...
public:
	...
	SOUND_API static AudioDevice null;
	 ...
	 */
	SOUND_API AudioDevice(const StringList & data);

	SOUND_API AudioDevice();

	SOUND_API AudioDevice(const AudioDevice & audioDevice);

	SOUND_API AudioDevice & operator=(const AudioDevice & audioDevice);

	SOUND_API virtual ~AudioDevice();

	/**
	 * Gets a human readable string representing this audio device.
	 */
	SOUND_API virtual std::string getName() const;
	 ...
	 */
	SOUND_API virtual StringList getData() const;
