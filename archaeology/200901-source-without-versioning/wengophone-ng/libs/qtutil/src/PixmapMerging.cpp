...
QPixmap PixmapMerging::merge(const QByteArray & foregroundPixmapData, const std::string & backgroundPixmapFilename) {
	QImage foregroundImage = QImage::fromData(foregroundPixmapData);
