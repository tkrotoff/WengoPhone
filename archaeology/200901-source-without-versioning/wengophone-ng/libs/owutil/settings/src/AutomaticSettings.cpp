...
AutomaticSettings::AutomaticSettings(const AutomaticSettings & settings)
	: Settings(settings) {

	_keyDefaultValueMap = settings._keyDefaultValueMap;
}
...
std::string AutomaticSettings::get(const std::string &, const std::string &) const {
	return String::null;
}

StringList AutomaticSettings::get(const std::string &, const StringList &) const {
	static const StringList empty;
	return empty;
}

bool AutomaticSettings::get(const std::string &, bool) const {
	return false;
}

int AutomaticSettings::get(const std::string &, int) const {
	return 0;
}

boost::any AutomaticSettings::getAny(const std::string &, const boost::any &) const {
