...
public:
	 ...
	 * strList += "good";
	 * strList += "wengo";
	 * unsigned i = strList.contains("wengo");	//i = 2
	 * unsigned j = strList.contains("Wengo");	//j = 0
	 * unsigned k = strList.contains("Wengo", false);	//k = 2
	 * </pre>
	 *
	 ...
	 */
	OWUTIL_API std::string toString(const std::string & separator = " ") const;
