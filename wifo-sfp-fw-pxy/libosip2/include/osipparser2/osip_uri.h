...
/**
 * Remove in a url parameter element from the list.
 * @param url_params The list of url parameter element to work on.
 * @param name The name of the parameter element to find.
 */
  int osip_uri_param_remove_byname (osip_list_t * url_params, char *name);
...
/**
 * Remove in a generic parameter element from the  list.
 * @param url_headers The list of generic parameter element to work on.
 * @param name The name of the parameter element to remove.
 */
#define osip_uri_header_remove_byname(url_headers,name) osip_uri_param_remove_byname(url_headers,name)
...
/**
 * Remove in a url header element in a url element.
 * @param url The element to work on.
 * @param name The name of the url header element to find.
 */
#define osip_uri_uheader_remove_byname(url,name) osip_uri_header_remove_byname(url->url_headers,name)
